...
IEmbeddingGenerator<string, Embedding<float>> embeddingGenerator =
    new OllamaEmbeddingGenerator(new Uri("http://127.0.0.1:11434"), modelId: "nomic-embed-text");

var qdrantClient = new Qdrant.Client.QdrantClient("127.0.0.1");
if (!await qdrantClient.CollectionExistsAsync("manuals"))
{
    await qdrantClient.CreateCollectionAsync("manuals", new VectorParams { Size = 768, Distance = Distance.Cosine });
}
